...
- npm publication is handled by `.github/workflows/publish.yml` on GitHub Release publication, using npm trusted publishing/OIDC and the GitHub `npm` environment.
